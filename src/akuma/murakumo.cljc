...
(defn collection
  [name]
  (str "com.etzhayyim.akuma." name))

(def cell-specs {
  :runprobe {:legacy-cell "com-etzhayyim-apps-akuma-runProbe"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "runprobe")]
     :required-gates common-gates
     :trigger "manifest cell runprobe"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :scope {:legacy-cell "com-etzhayyim-apps-akuma-scope"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "scope")]
     :required-gates common-gates
     :trigger "manifest cell scope"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :finding {:legacy-cell "com-etzhayyim-apps-akuma-finding"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "finding")]
     :required-gates common-gates
     :trigger "manifest cell finding"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :risk {:legacy-cell "com-etzhayyim-apps-yabai-risk"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :indicator {:legacy-cell "com-etzhayyim-apps-malak-indicator"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "indicator")]
     :required-gates common-gates
     :trigger "manifest cell indicator"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
